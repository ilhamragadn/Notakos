...
export default class NotifService {
  ...
  localNotif(soundName: string | undefined) {
    this.lastId++;
  ...
  scheduleNotif(soundName: string | undefined) {
    this.lastId++;
    ...
    times.forEach(time => {
      ...
      PushNotification.localNotificationSchedule({
        ...
        bigText:
          '<strong>Jangan lupa!</strong> Catat keuangan harianmu sebelum uangmu habis duluan.', // (optional) default: "message" prop
        //   subText: 'none', // (optional) default: none
        color: '#0284C7', // (optional) default: system default
        vibrate: true, // (optional) default: true
        vibration: 300, // vibration length in milliseconds, ignored if vibrate=false, default: 1000
        tag: 'some_tag', // (optional) add tag to message
        group: 'group', // (optional) add group to message
        ...
        /* iOS and Android properties */
        id: this.lastId, // (optional) Valid unique 32 bit integer specified as string. default: Autogenerated Unique ID
        title: 'Catat Keuanganmu di NOTAKOS', // (optional)
        message: 'My Notification Message', // (required)
        userInfo: {screen: 'home'}, // (optional) default: {} (using null throws a JSON value '<null>' error)
        playSound: !!soundName, // (optional) default: true
        soundName: soundName ? soundName : 'default', // (optional) Sound to play when the notification is shown. Value of 'default' plays the default sound. It can be set to a custom sound such as 'android.resource://com.xyz/raw/my_sound'. It will look for the 'my_sound' audio file in 'res/raw' directory and play it. default: 'default' (default sound is played)
