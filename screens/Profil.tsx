                  ...
                  <View
                    ...
                    <View style={{width: 300, marginHorizontal: 4}}>
                      <Text style={{color: '#0D6EFD', textAlign: 'justify'}}>
                        Mohon cantumkan juga email orang tuamu. Email orang tua
                        dibutuhkan agar orang tua menerima notifikasi hasil
                        rekapitulasi pencatatan keuanganmu sehingga catatan
                        keuanganmu dapat dipantau oleh orang tuamu.
                      </Text>
                    </View>
                  </View>
                </View>
              ...
              <Card>
                ...
                <View
                  ...
                  <Text style={{textAlign: 'justify'}}>
                    NOTAKOS adalah sebuah aplikasi yang bertujuan untuk membantu
                    mahasiswa indekos dalam mengelola keuangan pribadinya dengan
                    memanfaatkan sistem alokasi uang. Sehingga, mahasiswa yang
                    menggunakan aplikasi NOTAKOS terbantu dalam proses
